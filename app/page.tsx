    ...
    />
        ...
        <div className="absolute right-1/2 translate-x-1/2 transform">
          <div className="hidden md:flex gap-x-10 items-center text-white font-medium text-lg cursor-pointer">
            <Link href={"/showcase"} className="hover:text-[#FFD700]"
            >
              Showcase
            </Link>
...
className="hover:text-[#FFD700]"
        ...
        <div className="flex items-center gap-x-4">
          <a href="tel:01000000" className="hidden lg:flex">
...
<div className="md:flex items-center justify-between gap-y-4 my-10 gap-x-28 mx-auto">
  ...
  <main className="md:px-0 mx-6 md:mx-auto">
    <h1 className="text-3xl md:text-5xl md:text-center font-medium flex items-center gap-x-2 mx-auto justify-center text-white">
      ...
      <footer className="bg-black text-white py-10  px-6 md:px-0 md:mx-auto border-t">
        <div className="flex flex-col  justify-between gap-y-3 xl:w-4/5 2xl:w-[68%] mx-auto">
          ...
          <p className="text-left  text-xl  text-white-500">01000000000</p>
          <p className="text-left  text-xl  text-white-500">
            admin@crossbar
          </p>
        </div>

        <div className="flex md:justify-center gap-x-4 mt-10">
          © 2025 crossbar. All Rights Reserved.
