...
const Meeting = () => {
  return (
    <div className="
      ...
      bg-[#000000] bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]
    ">
      <ShowcaseNavbar />
      <div className="md:px-0 px-6 xl:w-4/5 2xl:w-[68%] justify-between md:mt-14 md:flex mx-auto">
        <div className="md:w-2/5">
          <h1 className="text-4xl font-semibold pt-10 text-white">Let&apos;s Meet</h1>
          ...
          {[
            ...
            >
              <PiCheckCircle className="rounded-md text-yellow-500 text-2xl flex-shrink-0" />
              <ul>
